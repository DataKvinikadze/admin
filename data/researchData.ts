...
export const creditResearch: Research[] = [
  {
    ...
    summary: {
      en: "A comprehensive look into credit market volatility.",
      ka: "ა კომპერ",
    },
...
export const marketResearch: Research[] = [
  {
    ...
    summary: {
      en: "Emerging market performance across sectors.",
      ka: "დამწყები ბაზრების შესრულება სხვადასხვა სექტორში.",
    },
  ...
  },
  {
    _id: "2",
    title: {
      en: "Quarterly Market Report Q1",
      ka: "კვარტალური საბაზრო ანგარიში Q1",
    },
    summary: {
      en: "Summary of market conditions in Q1.",
      ka: "Q1-ის საბაზრო მდგომარეობის შეჯამება.",
    },
    category: ResearchCategory.MARKET,
  ...
  },
  {
    ...
    summary: {
      en: "Trends in global commodity prices.",
      ka: "გლობალურ საქონლის ფასებში ტენდენციები.",
    },
    category: ResearchCategory.MARKET,
...
export const governanceResearch: Research[] = [
  {
    _id: "1",
    title: {
      en: "Corporate Governance Index 2025",
      ka: "კორპორაციული მმართველობის ინდექსი 2025",
    },
    summary: {
      en: "Evaluating governance scores across sectors.",
      ka: "მმართველობის ქულების შეფასება სექტორების მიხედვით.",
    },
  ...
  },
  {
    _id: "2",
    title: {
      en: "Board Effectiveness Study",
      ka: "ბორდის ეფექტიანობის კვლევა",
    },
    summary: {
      en: "Study on decision-making in boards of directors.",
      ka: "ბორდების გადაწყვეტილებების მიღების კვლევა.",
    },
    category: ResearchCategory.GOVERNANCE,
  ...
  },
  {
    _id: "3",
    title: {
      en: "Governance & Risk Alignment",
      ka: "მმართველობა და რისკების თანხვედრა",
    },
    summary: {
      en: "How governance policies align with risk management.",
      ka: "როგორ შეესაბამება მმართველობის პოლიტიკა რისკების მართვას.",
    },
    category: ResearchCategory.GOVERNANCE,
...
export const policyResearch: Research[] = [
  {
    _id: "1",
    title: {
      en: "Fiscal Policy Overview",
      ka: "ფისკალური პოლიტიკის მიმოხილვა",
    },
    summary: {
      en: "Current trends in fiscal policy decisions.",
      ka: "ფისკალური პოლიტიკის მიმდინარე ტენდენციები.",
    },
  ...
  },
  {
    ...
    summary: {
      en: "The effect of interest rate changes.",
      ka: "საკრედიტო განაკვეთების ცვლილებების გავლენა.",
    },
    category: ResearchCategory.POLICY,
    author: { en: "Grace Martinez", ka: "გრეის მარტინესი" },
    publishedDate: new Date(),
  ...
  },
  {
    ...
    summary: {
      en: "Latest changes in financial regulation.",
      ka: "ბოლო ცვლილებები ფინანსურ რეგულაციებში.",
    },
    category: ResearchCategory.POLICY,
    author: { en: "Grace Martinez", ka: "გრეის მარტინესი" },
    publishedDate: new Date(),
...
export const otherResearch: Research[] = [
  {
    _id: "1",
    title: {
      en: "ESG and Investment Strategy",
      ka: "ESG და საინვესტიციო სტრატეგია",
    },
    summary: {
      en: "Environmental, Social, and Governance insights.",
      ka: "გარემოს, სოციალური და მმართველობის ანალიზი.",
    },
  ...
  },
  {
    _id: "2",
    title: {
      en: "Digital Finance Trends",
      ka: "ციფრული ფინანსების ტენდენციები",
    },
    summary: {
      en: "The rise of fintech and decentralized finance.",
      ka: "ფინტექისა და დეცენტრალიზებული ფინანსების ზრდა.",
    },
    category: ResearchCategory.OTHER,
  ...
  },
  {
    ...
    summary: {
      en: "How psychology influences economic decisions.",
      ka: "როგორ ახდენს ფსიქოლოგია გავლენას ეკონომიკურ გადაწყვეტილებებზე.",
    },
    category: ResearchCategory.OTHER,
    author: { en: "Alice Johnson", ka: "ალის ჯონსონი" },
    publishedDate: new Date(),
